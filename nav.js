...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (socialContainer) {
        socialContainer.innerHTML = `
            <a href="https://open.spotify.com/artist/5GxEhBJJmhGECHQvsh9LRz?si=PJw0CXDIRdmBn7mDuviCZg&utm_source=copy-link" target="_blank" class="cta-button" style="background-color: #1DB954;">
