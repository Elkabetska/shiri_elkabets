...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const tabsData = [
        ...
        {
            href: "ensemble.html", // קישור חדש לדף אנסמבל מענה קולי
            img: "images/ansamble.jpeg",
            alt: "אנסמבל מענה קולי",
            label: "אנסמבל מענה קולי",
            activeKey: "ensemble.html"
        },
        {
            href: "bodyvoice.html",
    ...
    if (socialContainer) {
        socialContainer.innerHTML = `
            <a href="https://open.spotify.com/artist/5GxEhBJJmhGECHQvsh9LRz?si=PJw0CXDIRdmBn7mDuviCZg" onclick="if(/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)){window.location.href='spotify:artist:5GxEhBJJmhGECHQvsh9LRz'; event.preventDefault();}" target="_blank" class="cta-button" style="background-color: #1DB954;">
            ...
            <a href="https://www.instagram.com/shiri_elkabetska/" target="_blank" class="cta-button" style="background-color: #E1306C;">
